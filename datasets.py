...
class Dataset(DatasetSubclass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.lr_transforms = T.Compose([
            T.Normalize((-1.0, -1.0, -1.0), (2.0, 2.0, 2.0)),
            T.ToPILImage(),
            T.Resize(lr_size, interpolation=Image.BICUBIC),
            T.ToTensor(),
        ])
    ...
    def __getitem__(self, idx):
        ...
        image = th.from_numpy(self.data[idx])
    ...
    def collate_fn(batch):
        ...
        return th.stack(hrs, dim=0)m th.stack(lrs, dim=0)

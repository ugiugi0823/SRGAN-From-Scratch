...
class ResidualBlock(nn.Module):
    ...
    ResidualBlock Class
    Values 
        channels: the number of channels throught the residual blcok, a scalar
    """
...
class Generator(nn.Module):
    ...
    Generator Class
    Values:
        base_channels: number of channels throught the generator,a scalar
...
class Discriminator(nn.Module):
    ...
    Discriminator Class
    Values: 
        base_channels: number of channels in first convolutinal layer, a scalar
        n_blocks: number of convolutinal blocks, a scalar
    """
    ...
    def __init__(self, base_channels=64, n_blocks=3):
        ...
        for i in range(n_blocks):
            self.blocks += [
                ...
                nn.Conv2d(2 * cur_channels, 2 * cur_channels, kernel_size=3, padding=1),
                nn.BatchNorm2d(2 * cur_channels),
                nn.LeakyReLU(0.2, inplace=True),
            ]
